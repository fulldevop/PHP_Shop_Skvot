    ...
    public function run()
    {
      ...
      $users = [
          [
              'login' => 'admin',
              'email' => 'admin@mail.ru',
              'phone' => '+7(495)855-85-85',
              'address' => 'г.Москва, ул.Ленина, д.80, кв.80',
              'role' => '1',
              'pass' => password_hash(123, PASSWORD_DEFAULT, ['cost' => 11, 'salt' => 'jd64hvnf8dgst30ghi78cvsh5ng4jgl1']),
              'hash' => '',
          ],
          [
              'login' => 'user',
              'email' => 'andrew789@ya.ru',
              'phone' => '+7(960)960-60-60',
              'address' => 'г.Санкт-Петербург, ул.Толстого, д.50, кв.50',
              'role' => '2',
              'pass' => password_hash(1234, PASSWORD_DEFAULT, ['cost' => 11, 'salt' => 'jd64hvnf8dgst30ghi78cvsh5ng4jgl1']),
              'hash' => '',
          ],
      ];
      ...
      $this->table('status')->insert($statuses)->save();
    }
}
